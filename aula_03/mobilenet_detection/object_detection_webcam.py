...
def detect(frame):
    ...
    for i in np.arange(0, detections.shape[2]):
        ...
        if confidence > args["confidence"]:
            ...
            print("testeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee",results)
...
while(True):
    ...
    if len(result_tuples[0]) > 0:
        if result_tuples[0][0] == "bottle":
            count_frames += 1
    ...
    if count_frames >= 5:
        if initBB is not None:
            ...
            initBB = result_tuples #TESTEEEEEEEEEEEEEEEEEEE
